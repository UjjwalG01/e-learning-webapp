...
export function FAQsSection({ className }) {
    return (
        <section className={`my-8 lg:my-10 px-4 lg:px-10 max-w-[45rem] mx-auto ${className}`}>
            <div className="grid lg:grid-cols-[1fr_2fr] gap-4">
                <div className="h-fit flex flex-col gap-3 p-3">
                    <h2 className="fs-400 font-semibold">Frequently Asked Questions</h2>
                    <p className="fs-100 font-medium">Still you have any questions? Contact our Team via siksha@learningschool.com</p>
