...
export function About() {
    return (
        <motion.main
            ...
            <HeroSection title={"About Siksha Learning School"} className={"text-white"} img={img} description={"Welcome to our platform, where we are passionate about empowering individuals to master the world of design and development. We offer a wide range of online courses designed to equip learners with the skills and knowledge needed to succeed in the ever-evolving digital landscape."} />
            <AchievementSection />
            <GoalSection />
            <AboutFooterSection />
        </motion.main>
